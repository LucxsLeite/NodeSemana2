...
import type { ComentsRepository, ComentWithAll } from "@/repositories/coments-repository.js"
...
export class CreateComentUseCase {
  constructor(private comentsRepository: ComentsRepository, private usersRepository: UsersRepository, private postsRepository: PostsRepository) {}
  async execute({
    conteudo,
    usuarioPublicId,
    postPublicId,
